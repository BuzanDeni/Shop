...
public partial class user_cart : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        dt.Columns.AddRange(new DataColumn[7] { new DataColumn("product_name"), new DataColumn("product_descr"), new DataColumn("product_price"), new DataColumn("quantity"), new DataColumn("product_images"),new DataColumn("id"), new DataColumn("product_id") });
