...
public partial class user_payment_success : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // {
            //asa se iau detaliile clientului si se pun in tab order_details
            ...
            if (Request.Cookies["aa"] != null)
            {
                ...
                ///again we take all values from cookies and store in the following data Table
            ...
            //sfarsit getting items from cookies
